    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <motion.div
                ...
                className={`glass-panel p-8 w-full relative z-10 border-t-4 border-t-violet-500 transition-all duration-500 ${result ? 'max-w-6xl' : 'max-w-2xl'}`}
            >
                <div className={`relative z-10 ${result ? 'grid grid-cols-1 lg:grid-cols-2 gap-8 items-start' : ''}`}>
